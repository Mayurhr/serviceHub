    ...
    <footer className="bg-ink-900 text-ink-300 mt-auto">
      <div className="page-container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-ink-400 text-sm leading-relaxed mb-4 max-w-xs">
              Book verified local service professionals in Davanagere, Shivamogga, Honnali, Sagar and Bhadravathi.
            </p>
        ...
        <div className="border-t border-ink-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-ink-500 text-sm">© 2024 ServeEase Pro. All rights reserved.</p>
          <p className="text-ink-600 text-xs">Built with 🧡 for Karnataka · MERN Stack</p>
        </div>
      </div>
    </footer>
  );
