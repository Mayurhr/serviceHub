          ...
          <div className="hidden md:flex items-center gap-6">
            {!isProvider && (
              <>
                ...
                {user && !isAdmin && <><Link to="/dashboard" className={`text-sm font-bold transition-colors ${nav('/dashboard')}`}>Dashboard</Link><Link to="/my-bookings" className={`text-sm font-medium transition-colors ${nav('/my-bookings')}`}>My Bookings</Link></> }
