          ...
          <div className="card-flat p-6 sticky top-24">
            <div className="text-center mb-5">
              <div className="relative inline-block mb-3">
                <img src={provider.avatar || `https://i.pravatar.cc/120?u=${provider._id}`}
                  alt={provider.name} className="w-24 h-24 rounded-2xl object-cover ring-4 ring-ink-100 mx-auto"
                  onError={e => e.target.src=`https://i.pravatar.cc/120?u=${provider._id}`}/>
