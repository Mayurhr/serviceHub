...
export default function AdminServices() {
  ...
  const openAdd = () => { setEditing(null); setForm(emptyForm); setImgError(false); setModal(true); };
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[92vh] overflow-y-auto animate-scale-in">
            ...
            <form onSubmit={save} className="p-6 space-y-4">
              {/* Image */}
              <div>
                <label className="block text-sm font-bold text-ink-700 mb-2">Service Image URL</label>
